...
class InitialPowerParams(CAMB_Structure):
    ...
    def set_params(self, As=2e-9, ns=0.96, nrun=0, nrunrun=0.0, r=0.0, nt=None, ntrun=0.0,
                   pivot_scalar=0.05, pivot_tensor=0.05, parameterization=tensor_param_rpivot,kXpivot=0.0,epsX=0.0):
        """
	...
	:param kXpivot: The k where power is added
	:param epsX: the power at kXpivot
